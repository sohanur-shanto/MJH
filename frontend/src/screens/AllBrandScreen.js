...
function AllBrandScreen() {
    ...
    return (
        <div>
                    ...
                    <Row className='flex flex-wrap' style={{ marginTop: 20, marginBottom:100 }}> 
                            <h3 style={{ textAlign: "center", marginTop: 100 }}><b>Shop By Brands <i class="fas fa-gifts" style={{color:'green'}}></i></b></h3>
                            <hr />
