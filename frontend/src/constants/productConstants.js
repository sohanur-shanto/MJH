...
export const PRODUCT_STORM_REQUEST = 'PRODUCT_STORM_REQUEST'
export const PRODUCT_STORM_SUCCESS = 'PRODUCT_STORM_SUCCESS'
export const PRODUCT_STORM_FAIL = 'PRODUCT_STORM_FAIL'