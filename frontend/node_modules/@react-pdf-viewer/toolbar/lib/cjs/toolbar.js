...
var MoreActionsPopover = function (_a) {
    ...
    var renderTarget = function (toggle, opened) {
        ...
        return (React__namespace.createElement(core.Tooltip, { ariaControlsSuffix: "toolbar-more-actions", position: core.Position.BottomRight, target: React__namespace.createElement(core.MinimalButton, { ariaLabel: label, onClick: toggle, isSelected: opened },
    ...
    return (React__namespace.createElement(core.Popover, { ariaControlsSuffix: "toolbar-more-actions", ariaHasPopup: "menu", position: core.Position.BottomRight, target: renderTarget, content: renderContent, offset: PORTAL_OFFSET, closeOnClickOutside: true, closeOnEscape: true }));
};
...
var defaultToolbar = function (toolbarSlot) {
    ...
    return (React__namespace.createElement("div", { className: "rpv-toolbar", role: "toolbar", "aria-orientation": "horizontal" },
