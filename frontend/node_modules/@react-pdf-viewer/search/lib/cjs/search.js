...
var SearchPopover = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: "rpv-search__popover" },
        React__namespace.createElement("div", { className: "rpv-search__popover-input-counter" },
            React__namespace.createElement(core.TextBox, { ariaLabel: searchLabel, placeholder: searchLabel, type: "text", value: keyword, onChange: setKeyword, onKeyDown: onKeydownSearch }),
        ...
        React__namespace.createElement("div", { className: "rpv-search__popover-footer" },
            React__namespace.createElement("div", { className: "rpv-search__popover-footer-item" },
                React__namespace.createElement(core.Tooltip, { ariaControlsSuffix: "search-previous-match", position: core.Position.BottomCenter, target: React__namespace.createElement(core.MinimalButton, { ariaLabel: previousMatchLabel, isDisabled: currentMatch <= 1, onClick: jumpToPreviousMatch },
...
var SearchIcon = function () { return (React__namespace.createElement(core.Icon, { size: 16 },
...
var ShowSearchPopover = function (_a) {
    ...
    return (React__namespace.createElement(core.Popover, { ariaControlsSuffix: "search", position: core.Position.BottomLeft, target: function (toggle) {
            return render({
                onClick: toggle,
            });
