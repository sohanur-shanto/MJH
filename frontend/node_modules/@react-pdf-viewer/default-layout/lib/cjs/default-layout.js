...
var Attachment__namespace = /*#__PURE__*/_interopNamespace(Attachment);
...
var Sidebar = function (_a) {
    ...
    var toggleTab = function (index) {
        currentTab === index ? setOpened(function (isOpened) { return !isOpened; }) : switchToTab(index);
    };
    ...
    return (React__namespace.createElement("div", { className: "rpv-default-layout__sidebar " + (opened ? 'rpv-default-layout__sidebar--opened' : '') },
        React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-tabs" },
            React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-headers", role: "tablist", "aria-orientation": "vertical" }, listTabs.map(function (tab, index) { return (React__namespace.createElement("div", { "aria-controls": "rpv-default-layout__sidebar-content", "aria-selected": currentTab === index, key: index, className: "rpv-default-layout__sidebar-header", id: "rpv-default-layout__sidebar-tab-" + index, role: "tab" },
                React__namespace.createElement(core.Tooltip, { ariaControlsSuffix: "default-layout-sidebar-tab-" + index, position: core.Position.RightCenter, target: React__namespace.createElement(core.MinimalButton, { ariaLabel: tab.title, isSelected: currentTab === index, onClick: function () { return toggleTab(index); } }, tab.icon), content: function () { return tab.title; }, offset: TOOLTIP_OFFSET }))); })),
            React__namespace.createElement("div", { "aria-labelledby": "rpv-default-layout__sidebar-tab-" + currentTab, id: "rpv-default-layout__sidebar-content", className: "rpv-default-layout__sidebar-content " + (opened ? 'rpv-default-layout__sidebar-content--opened' : ''), role: "tabpanel", tabIndex: -1 }, listTabs[currentTab].content))));
};
...
var defaultLayoutPlugin = function (props) {
    ...
    var attachmentPluginInstance = Attachment__namespace.attachmentPlugin();
    ...
    return {
        ...
        renderViewer: function (renderProps) {
            ...
            slot.children = (React__namespace.createElement("div", { className: "rpv-default-layout__container" },
                ...
                React__namespace.createElement("div", { className: "rpv-default-layout__main" },
                    ...
                    React__namespace.createElement("div", __assign({ className: "rpv-default-layout__body", "data-testid": "default-layout__body" }, mergeSubSlot), slot.subSlot.children)),
                slot.children));
            slot.subSlot.attrs = {};
